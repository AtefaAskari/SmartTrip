                    ...
                    <form action="{{ route('trips.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="number" step="0.01" name="total_budget" id="total_budget" value="{{ old('total_budget') }}" required
                                       class="w-full rounded-md border-gray-300 shadow-sm">
                            ...
                            <div>
                                ...
                                <select name="visibility" id="visibility" required
                                        class="w-full rounded-md border-gray-300 shadow-sm">
                                    <option value="private" {{ old('visibility') == 'private' ? 'selected' : '' }}>Private (only me)</option>
                                    <option value="public" {{ old('visibility') == 'public' ? 'selected' : '' }}>Public (anyone with link)</option>
                                </select>
